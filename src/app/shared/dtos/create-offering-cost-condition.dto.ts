...
export class CreateOfferingCostConditionDTO {
  ...
  constructor({
    ...
    this.forma_pagamento = {
      ...
      taxa_inscricao:
        Number(stepFourFormThreeValues.taxa_inscricao) || undefined,
    };
    this.curso_gratuito = stepFourFormFourValues.curso_gratuito;
    this.valor_a_vista =
      Number(stepFourFormFourValues.valor_a_vista) || undefined;
    this.valor_a_vista_vencimento =
    ...
    this.parcelas_boleto = stepFourFormFourValues.parcelas_boleto.map(
      (parcela_boleto) => {
        return {
          ...
          valor: Number(parcela_boleto.valor),
    ...
    this.porcentagem_desconto_estudantes =
      ...
      undefined;
    this.opcao_desconto = stepFourFormFourValues.opcao_desconto.map((opcao) => {
      return {
        para: opcao.para,
    ...
    this.recurso = new Recurso({
      valor: Number(stepFourFormFourValues.recurso_valor) || undefined,
