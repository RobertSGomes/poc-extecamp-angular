...
export class UpdateOfferingDTO {
  ...
  constructor({
    ...
    if (stepThreeFormOneValues) {
      ...
      this.pagina_facebook =
        stepThreeFormOneValues.pagina_facebook || undefined;
    }

    if (stepThreeFormTwoValues) {
      this.inscricao = {
